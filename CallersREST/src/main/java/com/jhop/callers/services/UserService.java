...
@Service
/**
 * This handles users and their phones. Phones don't really exist independent of
 * users, so for this example we handle them together
 * 
 * @author jhopper
 *
 */
public class UserService {
	 ...
	 * 
	 * This isn't really needed for the functionality, but it is helpful for
	 * testing, to ensure there are no orphan phones
	 * 
	 * @return
	 */
	 ...
	 * @param aPhone
	 */
	public Phone addPhone(UUID userID, Phone aPhone) {
		...
		if (userOpt.isPresent()) {
			// TODO is there a reason the phone might not be added?
